...
namespace OnlineRailwayReservationSystem.Controllers
{
    public class RoutesController : Controller
    {
        ...
        {
            var routes = db.Routes.Include(r => r.Train);
        ...
        public ActionResult Create([Bind(Include = "TrainID,RouteID,RouteSource,RouteDestination,TotalDistance,NumberOfStations")] Route route)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "TrainID,RouteID,RouteSource,RouteDestination,TotalDistance,NumberOfStations")] Route route)
        {
            if (ModelState.IsValid)
            {
