...
namespace OnlineRailwayReservationSystem.Controllers
{
    public class CoachesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "CoachID,TrainID,Class,TotalNumberOfSeat,TotalNumberOfBirth")] Coach coach)
        {
            ...
            ViewBag.TrainID = new SelectList(db.Trains, "TrainID", "TrainName", coach.TrainID);
            return View(coach);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "CoachID,TrainID,Class,TotalNumberOfSeat,TotalNumberOfBirth")] Coach coach)
        {
            if (ModelState.IsValid)
            {
